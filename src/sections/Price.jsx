    ...
    <section className="mt-32">
      ...
      <div className="xl:py-12 lg:py-8 lg:px-12 md:py-6 md:px-10 sm:py-4 sm:px-8 gap-10 grid grid-cols-1 lg:grid-cols-3 justify-between mt-20">
        {trips.map((trip, index) => (
          <div
            key={trip.id}
            className={`bg-[#FFE7AC] rounded-3xl xl:py-10 xl:px-8 lg:py-8 lg:px-6 py-4 px-4 border-2 border-black shadow-[10px_10px_0px_0px_rgba(0,0,0,0.75)] ${
              index === 1
                ? "lg:mt-[-3rem] lg:mb-[3rem] trips-purple text-white"
                : ""
            }`}
          >
